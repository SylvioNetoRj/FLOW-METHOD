...
- `installed_path` = `{project-root}/_flow/bmm/workflows/document-project/workflows`
- `instructions` = `{installed_path}/full-scan-instructions.md`
- `validation` = `{project-root}/_flow/bmm/workflows/document-project/checklist.md`
- `documentation_requirements_csv` = `{project-root}/_flow/bmm/workflows/document-project/documentation-requirements.csv`
