...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      logo: {
        light: './public/img/flow-light.png',
        dark: './public/img/flow-dark.png',
        alt: 'FLOW Method',
        replacesTitle: true,
      },
      favicon: '/favicon.ico',
      ...
      social: [
        ...
        { icon: 'github', label: 'GitHub', href: 'https://github.com/SylvioNetoRj/FLOW-METHOD' },
        { icon: 'youtube', label: 'YouTube', href: 'https://www.youtube.com/@FLOWCode' },
      ],
      ...
      head: [
        {
          ...
          attrs: {
            name: 'ai-terms',
            content: `AI-optimized documentation: ${siteUrl}/llms-full.txt (plain text, ~100k tokens, complete FLOW reference). Index: ${siteUrl}/llms.txt`,
          },
        },
        {
          tag: 'meta',
