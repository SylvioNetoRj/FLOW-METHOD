...
- FLOW PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure FLOW PRD principles compliance:
...
- Restructuring: Reformat content to FLOW standard
...
**For restructuring:**
- Reorganize PRD to FLOW standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match FLOW format

**Follow FLOW PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
FLOW standard structure applied.
