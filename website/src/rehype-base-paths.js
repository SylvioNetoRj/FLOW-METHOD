 ...
 *
 * Transforms:
 *   /img/foo.png → /FLOW-METHOD/img/foo.png (when base is /FLOW-METHOD/)
 *   /llms.txt → /FLOW-METHOD/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/FLOW-METHOD/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /FLOW-METHOD/img/foo.png.
