...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with the current UX patterns content
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
