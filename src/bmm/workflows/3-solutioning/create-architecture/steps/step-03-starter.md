...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with current starter analysis
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
