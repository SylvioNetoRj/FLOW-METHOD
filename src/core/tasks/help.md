...
- Show the command prefixed with `/` (e.g., `/flow-bmm-create-prd`)

### Skill-Referenced Workflows
When `workflow-file` starts with `skill:`:
- The value is a skill reference (e.g., `skill:flow-quick-dev-new-preview`), NOT a file path
