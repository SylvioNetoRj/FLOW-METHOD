...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with the current user journey content
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.
