...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with current project structure
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with project structure context
...
- Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
