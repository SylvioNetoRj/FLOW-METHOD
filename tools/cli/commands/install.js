...
module.exports = {
  command: 'install',
  description: 'Install FLOW Core agents and tools',
  options: [
    ...
    ['--output-folder <path>', 'Output folder path relative to project root (default: _flow-output)'],
  ...
  action: async (options) => {
    try {
      ...
      if (options.debug) {
        process.env.FLOW_DEBUG_MANIFEST = 'true';
