...
Detect if PRD follows FLOW format and route appropriately - classify as FLOW Standard / FLOW Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for FLOW PRD Core Sections

Check if the PRD contains the following FLOW PRD core sections:
...
- Follows FLOW PRD structure closely

**FLOW Variant:**
- 3-4 core sections present
- Generally follows FLOW patterns but may have structural differences
- Missing some sections but recognizable as FLOW-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow FLOW PRD structure
...
**Format Classification:** [FLOW Standard / FLOW Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is FLOW Standard or FLOW Variant:**
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach FLOW PRD parity
...
- FLOW core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- FLOW Standard/Variant PRDs proceed directly to next validation step
