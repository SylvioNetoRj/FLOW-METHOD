...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with current patterns
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with implementation patterns context
...
- Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md` to define the complete project structure.
