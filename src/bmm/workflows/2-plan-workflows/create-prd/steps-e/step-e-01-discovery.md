...
prdPurpose: '{project-root}/_flow/bmm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
advancedElicitationTask: '{project-root}/_flow/core/workflows/advanced-elicitation/workflow.md'
partyModeWorkflow: '{project-root}/_flow/core/workflows/party-mode/workflow.md'
---
...
This file defines what makes a great FLOW PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to FLOW format (if legacy PRD)
...
**Check for FLOW PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **FLOW Standard:** 5-6 core sections present
- **FLOW Variant:** 3-4 core sections present, generally follows FLOW patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow FLOW structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is FLOW Standard/Variant:**
...
This PRD does not follow FLOW standard structure (only {count}/6 core sections present).
...
**[C] Convert to FLOW Format** - Convert PRD to FLOW standard structure, then apply your edits
...
- FLOW PRDs proceed directly to review step
