...
| Skill        | Agent   | Purpose                              |
| ------------ | ------- | ------------------------------------ |
| `flow-brainstorming` | Analyst | Brainstorm a new project             |
| `flow-create-prd`        | PM      | Create Product Requirements Document |
```
...
Only for FLOW Method and Enterprise tracks. Quick Flow skips to implementation.

### Can I change my plan later?

Yes. The SM agent has a `flow-correct-course` workflow for handling scope changes.
