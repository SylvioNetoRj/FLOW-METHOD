...
# File References
nextStepFile: '{project-root}/_flow/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-07-project-type.md'
outputFile: '{planning_artifacts}/{active_feature}/prd.md'

# Data Files
projectTypesCSV: '{project-root}/_flow/bmm/workflows/2-plan-workflows/create-prd/data/project-types.csv'
