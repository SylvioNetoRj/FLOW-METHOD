...
Analyze legacy PRD against FLOW standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring FLOW standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against FLOW standard
...
**For each FLOW PRD section, analyze:**
...
- Manually check PRD for each FLOW section
...
**[R] Restructure to FLOW** - Full conversion to FLOW format, then apply your edits
...
- All 6 FLOW core sections analyzed for gaps
