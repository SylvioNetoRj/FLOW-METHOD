...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with the current component strategy content
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.
