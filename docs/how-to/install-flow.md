---
title: "How to Install FLOW"
description: Step-by-step guide to installing FLOW in your project
sidebar:
  order: 1
---
...
- Starting a new project with FLOW
- Adding FLOW to an existing codebase
- Update the existing FLOW Installation
...
```bash
npx github:SylvioNetoRj/FLOW-METHOD install
```
:::

### 2. Choose Installation Location

The installer will ask where to install FLOW files:
...
Some platforms require skills to be explicitly enabled in settings before they appear. If you install FLOW and don't see the skills, check your platform's settings or ask your AI assistant how to enable skills.
:::

### 4. Choose Modules

The installer shows available modules. Select whichever ones you need — most users just want **FLOW Method** (the software development module).
...
│   └── ...
├── _flow-output/       # Generated artifacts
...
Run `flow-help` to verify everything works and see what to do next.

**FLOW-Help is your intelligent guide** that will:
...
```
flow-help I just installed, what should I do first?
flow-help What are my options for a SaaS project?
```
...
**Installer worked but something doesn't work later** — Your AI needs FLOW context to help. See [How to Get Answers About FLOW](./get-answers-about-flow.md) for how to point your AI at the right sources.
