...
Use the `flow-shard-doc` tool if you need to split large markdown files into smaller, organized files for better context management.
...
FLOW workflows use a **dual discovery system**:
