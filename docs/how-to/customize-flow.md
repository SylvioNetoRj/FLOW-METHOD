...
:::note[Prerequisites]
- FLOW installed in your project (see [How to Install FLOW](./install-flow.md))
...
```text
_flow/_config/agents/
├── core-flow-master.customize.yaml
...
| **Modify FLOW Installation** | Full installation flow for adding or removing modules               |
...
- Run `npx @flownetbr/flow-method install` and select **Recompile Agents** to apply changes
...
- Run `npx @flownetbr/flow-method install` and select **Recompile Agents** to restore defaults

## Workflow Customization

Customization of existing FLOW Method workflows and skills is coming soon.
