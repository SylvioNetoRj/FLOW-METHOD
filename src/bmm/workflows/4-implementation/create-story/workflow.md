...
- `installed_path` = `{project-root}/_flow/bmm/workflows/4-implementation/create-story`
...
<step n="6" goal="Update sprint status and finalize">
  ...
  <output>**🎯 ULTIMATE FLOW Method STORY CONTEXT CREATED, {user_name}!**
    ...
    **Next Steps:**
    ...
    4. Optional: If Test Architect module installed, run `/flow:tea:automate` after `dev-story` to generate guardrail tests
