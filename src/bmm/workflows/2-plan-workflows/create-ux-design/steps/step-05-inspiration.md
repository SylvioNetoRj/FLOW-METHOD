...
- When 'A' selected: Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md
- When 'P' selected: Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md
...
- IF A: Read fully and follow {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md and ask user "Accept improvements? (y/n)", if yes overwrite section in file, then redisplay menu
- IF P: Read fully and follow {project-root}/_flow/core/workflows/party-mode/workflow.md and ask user "Accept changes? (y/n)", if yes overwrite section in file, then redisplay menu
- IF C: Read fully and follow: `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-06-design-system.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-06-design-system.md` to choose the appropriate design system approach.
