...
- `installed_path` = `{project-root}/_flow/bmm/workflows/4-implementation/dev-story`
...
<workflow>
  ...
  <step n="10" goal="Completion communication and user support">
    ...
    <action>Recommended next steps (flexible based on project setup):
      ...
      - Optional: If Test Architect module installed, run `/flow:tea:automate` to expand guardrail tests
    </action>
