...
_HTTP/HTTPS Protocols: [Web-based communication patterns and flownet]_
...
_JSON and XML: [Structured data exchange formats and their flownet]_
...
- Load: `{project-root}/_flow/bmm/workflows/1-analysis/research/technical-steps/step-04-architectural-patterns.md`
...
After user selects 'C', load `{project-root}/_flow/bmm/workflows/1-analysis/research/technical-steps/step-04-architectural-patterns.md` to analyze architectural patterns, design decisions, and system structures for {{research_topic}}.
