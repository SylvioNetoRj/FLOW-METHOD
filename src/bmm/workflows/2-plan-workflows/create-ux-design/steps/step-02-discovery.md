...
- IF A: Read fully and follow {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md and process the results, ask user "Accept improvements? (y/n)", if yes overwrite section in file, then redisplay menu
- IF P: Read fully and follow {project-root}/_flow/core/workflows/party-mode/workflow.md and process the results, ask user "Accept changes? (y/n)", if yes overwrite section in file, then redisplay menu
- IF C: Read fully and follow: `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`
