...
// Source regex (line ~1081) — uses non-capturing group for _flow
const SOURCE_REGEX = /\{project-root\}\/(?:_flow)\/([^/]+)\/workflows\/(.+)/;

// Install regex (line ~1091) — uses non-capturing group for _flow,
// consistent with source regex
const INSTALL_REGEX = /\{project-root\}\/(?:_flow)\/([^/]+)\/workflows\/(.+)/;

// ---------------------------------------------------------------------------
// Test data
// ---------------------------------------------------------------------------
const sourcePath = '{project-root}/_flow/bmm/workflows/4-implementation/create-story/workflow.md';
const installPath = '{project-root}/_flow/bmgd/workflows/4-production/create-story/workflow.md';
