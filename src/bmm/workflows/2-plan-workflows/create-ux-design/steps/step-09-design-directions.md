...
- Read fully and follow: {project-root}/_flow/core/workflows/advanced-elicitation/workflow.md with the current design direction content
...
- Read fully and follow: {project-root}/_flow/core/workflows/party-mode/workflow.md with the current design direction
...
- Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md`
...
Write content to file immediately after generation. Load `{project-root}/_flow/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md` to design user journey flows.
