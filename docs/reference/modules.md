...
FLOW extends through official modules that you select during installation. These add-on modules provide specialized agents, workflows, and tasks for specific domains beyond the built-in core and BMM (Agile suite).

:::tip[Installing Modules]
Run `npx @flownetbr/flow-method install` and select the modules you want. The installer handles downloading, configuration, and IDE integration automatically.
:::

## FLOW Builder

Create custom agents, workflows, and domain-specific modules with guided assistance. FLOW Builder is the meta-module for extending the framework itself.

- **Code:** `bmb`
- **npm:** [`flow-builder`](https://www.npmjs.com/package/flow-builder)
- **GitHub:** [flow-code-org/flow-builder](https://github.com/flow-code-org/flow-builder)
...
- **Code:** `cis`
- **npm:** [`flow-creative-intelligence-suite`](https://www.npmjs.com/package/flow-creative-intelligence-suite)
- **GitHub:** [flow-code-org/flow-module-creative-intelligence-suite](https://github.com/flow-code-org/flow-module-creative-intelligence-suite)
...
- **Code:** `gds`
- **npm:** [`flow-game-dev-studio`](https://www.npmjs.com/package/flow-game-dev-studio)
- **GitHub:** [flow-code-org/flow-module-game-dev-studio](https://github.com/flow-code-org/flow-module-game-dev-studio)
...
- **GitHub:** [flow-code-org/flow-method-test-architecture-enterprise](https://github.com/flow-code-org/flow-method-test-architecture-enterprise)
...
Community modules and a module marketplace are coming. Check the [FLOW GitHub organization](https://github.com/flow-code-org) for updates.
