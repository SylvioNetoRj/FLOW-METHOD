...
- `installed_path` = `{project-root}/_flow/bmm/workflows/qa-generate-e2e-tests`
...
> **Install Test Architect (TEA) module**: <https://flow-code-org.github.io/flow-method-test-architecture-enterprise/>
