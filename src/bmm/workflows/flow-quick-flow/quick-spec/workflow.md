...
main_config: '{project-root}/_flow/bmm/config.yaml'
...
quick_dev_workflow: '{project-root}/_flow/bmm/workflows/flow-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/_flow/bmm/workflows/flow-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
