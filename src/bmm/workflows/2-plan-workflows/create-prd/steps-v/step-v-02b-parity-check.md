...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve FLOW PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve FLOW PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring FLOW PRD standards expertise and gap analysis
...
- 🎯 Analyze each FLOW PRD section for gaps
...
### 1. Analyze Each FLOW PRD Section

For each of the 6 FLOW PRD core sections, analyze:
...
**Overall Effort to Reach FLOW Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core FLOW PRD sections. The overall effort to reach FLOW standard is: **{effort level}**
...
- All 6 FLOW PRD sections analyzed for gaps
